/* constructor is a special member function,which does the job of constructing members of the class.
...
c) it has no return type
  ...
  When we don't write any constructor ,no-arg constructor is provided by system
  */
#include<iostream.h>
class MyClass
{
