/*following program will give error at runtime because here copy 
constructor is not getting called */
/* in order to solve this problem we have to overload = operator
which we will see in next program */
#include<iostream.h>
#include<string.h>
class MyClass
{
